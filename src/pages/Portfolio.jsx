          ...
          <div className="container">
            <div className="section-header text-center" style={{ marginBottom: 'var(--space-12)' }}>
              ...
              <p style={{
                ...
                A curated collection of my most impactful stories, investigative reports, and feature articles. Each piece represents months of research, interviews, and on-the-ground reporting.
              </p>
            </div>
            ...
            {error ? (
              ...
              <div className="text-center" style={{ padding: 'var(--space-12)' }}>
                <p style={{ fontSize: 'var(--text-lg)', color: 'var(--text-secondary)' }}>
                  {selectedCategory 
                    ? `No portfolio items found in ${selectedCategory}.`
