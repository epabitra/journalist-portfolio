...
const AdminPostEditor = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      console.log('Preparing to save - mediaUrls state:', mediaUrls);
      console.log('Preparing to save - mediaUrlsArray:', mediaUrlsArray);
      console.log('Preparing to save - media_urls JSON string:', mediaUrlsArray.length > 0 ? JSON.stringify(mediaUrlsArray) : '');
          ...
          <div className="admin-card">
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <p style={{ fontSize: 'var(--text-sm)', color: 'var(--text-secondary)', marginTop: 'var(--space-2)' }}>
                  Blog posts appear on the Blog page, News posts appear on the News & Updates page. Both option will show the post on both pages.
                </p>
              </div>
