    ...
    <>
      ...
      <div className="admin-page">
        <div className="admin-page-header">
          <div>
            <h1>Edit Profile</h1>
            <p className="page-subtitle">Manage your profile, social links, and account settings</p>
          </div>
          <button
            ...
            <div className="card-body">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  id="title"
                  {...register('title')}
                  placeholder="e.g., Award-Winning Journalist"
                />
              </div>
            ...
            <div className="card-body">
              <div className="form-group">
                ...
                <textarea
                  ...
                  {...register('short_bio')}
                  rows="3"
                  placeholder="A brief one-line or short description"
                />
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  {...register('bio')}
                  rows="8"
                  placeholder="Your full biography and background"
                />
                <small>Detailed biography displayed on the About page</small>
              </div>
            </div>
          </div>
            ...
            <div className="card-body">
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  {...register('experience')}
                  rows="6"
                  placeholder="Your professional experience, career highlights, etc."
                />
              </div>
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  {...register('awards')}
                  rows="4"
                  placeholder="Awards, honors, recognitions you've received"
                />
              </div>
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  placeholder="e.g., Investigative Journalism, Human Rights, Environmental Reporting"
                />
                <small>Comma-separated list of your areas of expertise</small>
              </div>
              ...
              <div className="form-group">
                ...
                />
                <small>Comma-separated list of languages you speak</small>
              </div>
            </div>
          </div>
